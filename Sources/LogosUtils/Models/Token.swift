...
public struct Token: LinguisticUnit, Hashable, Equatable, CustomStringConvertible {
	...
	init(reference: TokenReference, relatedReference: TokenReference? = nil, surfaceForm: String, lexicalID: String? = nil, morphologies: [Morphology]? = nil, translation: String? = nil) {
